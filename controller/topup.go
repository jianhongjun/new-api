...
func GetTopUpInfo(c *gin.Context) {
	...
	enableWechatNative := setting.WechatPayNativeEnabled && setting.WechatPayNativeReady()
	...
	data := gin.H{
		...
		"wechat_native_min_topup":    strconv.FormatInt(getWechatPayMinTopup(), 10),
